            ...
            <div className="filter-well">
              <form onSubmit={this.handleSubmit}>
                ...
                <FormGroup>
                    ...
                    <FormControl id="minPriceFilter" type="text" label="Price from" placeholder="0.00" ref="minPrice"/>
                </FormGroup>
                <FormGroup>
                    <ControlLabel>Price to</ControlLabel>
                    <FormControl id="maxPriceFilter" type="text" label="Price to" placeholder="0.00" ref="maxPrice"/>
                </FormGroup> 
                <ButtonGroup>
